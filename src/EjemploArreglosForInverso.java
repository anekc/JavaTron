    ...
    public static void main(String[] args) {
        ...
        */
        ...
        for (int i = 0; i < total; i++) {
            System.out.println("para indices " + i + ":" + productos[i]);
        }

        System.out.println("=========recorrer un arreglo a la inversa=============");

        for(int i= 0; i <total; i++){
            System.out.println("para i: " + (total-1-i) + " valor: " + productos[total-1-i]);
        }
        System.out.println("=========recorrer un arreglo a la inversa metodo 2=============");
